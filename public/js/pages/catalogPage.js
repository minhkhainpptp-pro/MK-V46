(function () {
  ...
  window.MKApp.registerPage('catalog', {
    ...
    template: function () {
      return '<div class="grid-2"><div class="card"><h3>Sản phẩm</h3><div class="actions"><input id="catalogProductQ" placeholder="Tìm sản phẩm"><button id="loadProductsBtn">Tải</button></div><table><thead><tr><th>Mã</th><th>Tên</th><th>Giá</th><th>Kho</th></tr></thead><tbody id="catalogProducts"></tbody></table></div><div class="card"><h3>Khách hàng</h3><div class="actions"><input id="catalogCustomerQ" placeholder="Tìm khách hàng"><button id="loadCustomersBtn">Tải</button></div><table><thead><tr><th>Mã</th><th>Tên</th><th>NVBH</th><th>NVGH</th></tr></thead><tbody id="catalogCustomers"></tbody></table></div><div class="card"><h3>Nhân sự</h3><button id="loadUsersBtn">Tải nhân sự</button><table><thead><tr><th>Mã</th><th>Tên</th><th>Vai trò</th></tr></thead><tbody id="catalogUsers"></tbody></table></div><div class="card"><h3>Kho</h3><button id="loadWarehousesBtn">Tải kho</button><table><thead><tr><th>Mã</th><th>Tên</th><th>Trạng thái</th></tr></thead><tbody id="catalogWarehouses"></tbody></table></div></div>';
    },
    mount: function () {
